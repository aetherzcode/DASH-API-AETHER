    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs Prince AETHERz</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
            ...
            <span style="display: block;"><br>By,<br>AETHER</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"AETHER" <support@aetherz.xyz',
        to: email,
        subject: 'Verify Email - Api Prince AETHERz',
        html: inboxGmail,
      };
